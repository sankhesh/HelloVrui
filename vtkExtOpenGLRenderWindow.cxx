/*=========================================================================
  ...
  Module:    vtkExtOpenGLRenderWindow.cxx
...
{
  friend class vtkExtOpenGLRenderWindow;
private:
...
vtkStandardNewMacro(vtkExtOpenGLRenderWindow);
...
XVisualInfo *vtkExtOpenGLRenderWindow::GetDesiredVisualInfo()
{
  return 0;
...
void vtkExtOpenGLRenderWindow::Frame()
{
  return;
...
bool vtkExtOpenGLRenderWindow::InitializeFromCurrentContext()
{
...
//
void vtkExtOpenGLRenderWindow::SetStereoCapableWindow(int capable)
{
   return;
...
void vtkExtOpenGLRenderWindow::CreateAWindow()
{
  return;
...
void vtkExtOpenGLRenderWindow::DestroyWindow()
{
  return;
...
void vtkExtOpenGLRenderWindow::CreateOffScreenWindow(int width, int height)
{
  return;
...
void vtkExtOpenGLRenderWindow::DestroyOffScreenWindow()
{
  return;
...
void vtkExtOpenGLRenderWindow::ResizeOffScreenWindow(int width, int height)
{
  return;
...
void vtkExtOpenGLRenderWindow::WindowInitialize (void)
{
  return;
...
void vtkExtOpenGLRenderWindow::Initialize (void)
{
    return;
...
void vtkExtOpenGLRenderWindow::Finalize (void)
{
  return;
...
void vtkExtOpenGLRenderWindow::SetFullScreen(int arg)
{
    return;
  int *temp;
...
void vtkExtOpenGLRenderWindow::PrefFullScreen()
{
  return;
...
// Resize the window.
void vtkExtOpenGLRenderWindow::WindowRemap()
{
  return;
...
void vtkExtOpenGLRenderWindow::Start(void)
{
  this->Initialize();
...
void vtkExtOpenGLRenderWindow::SetSize(int width,int height)
{
//  return;
...
int vtkExtOpenGLRenderWindow::GetDesiredDepth()
{  
  XVisualInfo *v;
  int depth = 0;
...
Visual *vtkExtOpenGLRenderWindow::GetDesiredVisual ()
{
  return 0;
...
Colormap vtkExtOpenGLRenderWindow::GetDesiredColormap ()
{
  XVisualInfo *v;
...
void vtkExtOpenGLRenderWindow::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkExtOpenGLRenderWindow::MakeCurrent()
{
...
bool vtkExtOpenGLRenderWindow::IsCurrent()
{
  bool result=false;
#ifdef VTK_OPENGL_HAS_OSMESA
  if(this->OffScreenRendering && this->Internal->OffScreenContextId)
...
void vtkExtOpenGLRenderWindow::SetForceMakeCurrent()
{
...
void *vtkExtOpenGLRenderWindow::GetGenericContext()
{
...
int vtkExtOpenGLRenderWindow::GetEventPending()
{
  XEvent report;
...
int *vtkExtOpenGLRenderWindow::GetScreenSize()
{
  // get the default display connection
  if (!this->DisplayId)
    {
...
int *vtkExtOpenGLRenderWindow::GetPosition(void)
{
  XWindowAttributes attribs;
  int x,y;
  Window child;
...
Display *vtkExtOpenGLRenderWindow::GetDisplayId()
{
...
Window vtkExtOpenGLRenderWindow::GetParentId()
{
...
Window vtkExtOpenGLRenderWindow::GetWindowId()
{
...
void vtkExtOpenGLRenderWindow::SetPosition(int x, int y)
{
...
void vtkExtOpenGLRenderWindow::SetParentId(Window arg)
{
//   if (this->ParentId)
//     {
...
void vtkExtOpenGLRenderWindow::SetWindowId(Window arg)
{
...
// Set this RenderWindow's X window id to a pre-existing window.
void vtkExtOpenGLRenderWindow::SetWindowInfo(char *info)
{
  int tmp;
...
// Set this RenderWindow's X window id to a pre-existing window.
void vtkExtOpenGLRenderWindow::SetNextWindowInfo(char *info)
{
  int tmp;
  sscanf(info,"%i",&tmp);
...
void vtkExtOpenGLRenderWindow::SetParentInfo(char *info)
{
  int tmp;
...
void vtkExtOpenGLRenderWindow::SetWindowId(void *arg)
{
  this->SetWindowId(reinterpret_cast<Window>(arg));
}
void vtkExtOpenGLRenderWindow::SetParentId(void *arg)
{
  this->SetParentId(reinterpret_cast<Window>(arg));
}

const char* vtkExtOpenGLRenderWindow::ReportCapabilities()
{
  MakeCurrent();
...
int vtkExtOpenGLRenderWindow::SupportsOpenGL()
{
  this->MakeCurrent();
  if (!this->DisplayId)
    {
...
int vtkExtOpenGLRenderWindow::IsDirect()
{
  this->MakeCurrent();
  this->UsingHardware = 0;
  if (this->OffScreenRendering && this->Internal->PbufferContextId)
...
void vtkExtOpenGLRenderWindow::SetWindowName(const char * cname)
{
...
void vtkExtOpenGLRenderWindow::SetNextWindowId(Window arg)
{
...
void vtkExtOpenGLRenderWindow::SetNextWindowId(void *arg)
{
...
// X display id.
void vtkExtOpenGLRenderWindow::SetDisplayId(Display  *arg)
{
...
void vtkExtOpenGLRenderWindow::SetDisplayId(void *arg)
{
  this->SetDisplayId(static_cast<Display *>(arg));
  this->OwnDisplay = 0;
}

void vtkExtOpenGLRenderWindow::Render()
{
  XWindowAttributes attribs;
...
//----------------------------------------------------------------------------
void vtkExtOpenGLRenderWindow::HideCursor()
{
...
//----------------------------------------------------------------------------
void vtkExtOpenGLRenderWindow::ShowCursor()
{
  if (!this->DisplayId || !this->WindowId)
    {
    this->CursorHidden = 0;
...
//============================================================================
// Stuff above this is almost a mirror of vtkExtOpenGLRenderWindow.
...
// (mangled) from vtkExtOpenGLRenderWindow like the other OpenGL classes.
//============================================================================

void vtkExtOpenGLRenderWindow::SetOffScreenRendering(int i)
{
...
void *vtkExtOpenGLRenderWindow::GetGenericWindowId()
{
#ifdef VTK_OPENGL_HAS_OSMESA
...
void vtkExtOpenGLRenderWindow::SetCurrentCursor(int shape)
{
